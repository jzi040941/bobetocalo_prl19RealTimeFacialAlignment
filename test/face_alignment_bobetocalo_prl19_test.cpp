  ...
  )
{
  ...
  std::cout<<"landmark db complete"<<std::endl;
  ...
  */
  ...
  faces[0].bbox.pos = cv::Rect(0,0,512,512);
  ...
  showResults(viewer, ticks, 1, frame, composite, faces, ann);
  //std::cout<<"End of face_alignment_bobetocalo_prl19_test"<<std::endl;
  }
  return EXIT_SUCCESS;
